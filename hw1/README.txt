...
python run_expert.py experts/Humanoid-v1.pkl Humanoid-v1 --render --num_rollouts [Number of Rollouts]
...
ex. python run_cloning.py experts/Ant-v1.pkl Ant-v1 data/Ant-v1_20_data.pkl --render --num_rollouts 20
...
ex. python dagger.py experts/Ant-v1.pkl Ant-v1 data/Ant-v1_20_data.pkl --render --num_rollouts 20
